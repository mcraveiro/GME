========================================================================
		ActiveX Control DLL : OBJECTINSPECTOR
========================================================================

ControlWizard has created this project for your OBJECTINSPECTOR ActiveX Control
...
that make up your OBJECTINSPECTOR ActiveX Control DLL.
...
ObjectInspectorCtl.h
	This file contains the declaration of the CObjectInspectorCtrl C++ class.

ObjectInspectorCtl.cpp
	This file contains the implementation of the CObjectInspectorCtrl C++ class.

ObjectInspectorPpg.h
	This file contains the declaration of the CObjectInspectorPropPage C++ class.

ObjectInspectorPpg.cpp
	This file contains the implementation of the CObjectInspectorPropPage C++ class.

ObjectInspectorCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CObjectInspectorCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ObjectInspector.rc.
