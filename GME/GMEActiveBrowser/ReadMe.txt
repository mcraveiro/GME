========================================================================
		ActiveX Control DLL : GMEACTIVEBROWSER
========================================================================

ControlWizard has created this project for your GMEACTIVEBROWSER ActiveX Control
...
that make up your GMEACTIVEBROWSER ActiveX Control DLL.

GMEActiveBrowser.dsp
...
/////////////////////////////////////////////////////////////////////////////
GMEActiveBrowser control:

GMEActiveBrowserCtl.h
	This file contains the declaration of the CGMEActiveBrowserCtrl C++ class.

GMEActiveBrowserCtl.cpp
	This file contains the implementation of the CGMEActiveBrowserCtrl C++ class.

GMEActiveBrowserPpg.h
	This file contains the declaration of the CGMEActiveBrowserPropPage C++ class.

GMEActiveBrowserPpg.cpp
	This file contains the implementation of the CGMEActiveBrowserPropPage C++ class.

GMEActiveBrowserCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGMEActiveBrowserCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GMEActiveBrowser.rc.
