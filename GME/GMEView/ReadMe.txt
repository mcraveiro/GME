========================================================================
    ACTIVEX CONTROL DLL : GMEView Project Overview
========================================================================

ControlWizard has created this project for your GMEView ActiveX Control
...
that make up your GMEView ActiveX Control DLL.
...
GMEView.ico
    ...
    is included by the main resource file GMEView.rc.

/////////////////////////////////////////////////////////////////////////////
CGMEViewCtrl control:

GMEViewCtrl.h
    This file contains the declaration of the CGMEViewCtrl C++ class.

GMEViewCtrl.cpp
    This file contains the implementation of the CGMEViewCtrl C++ class.

GMEViewPropPage.h
    This file contains the declaration of the CGMEViewPropPage C++ class.

GMEViewPropPage.cpp
    This file contains the implementation of the CGMEViewPropPage C++ class.

CGMEViewCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGMEViewCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GMEView.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GMEView.pch and a precompiled types (PCT) file named stdafx.obj.
