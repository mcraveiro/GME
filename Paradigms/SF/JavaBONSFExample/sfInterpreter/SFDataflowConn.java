 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SFDataflowConn extends JBuilderConnection {

	/**
	 * @param iConn
	 * @param parent
	 */
	public SFDataflowConn(MgaSimpleConnection iConn, JBuilderModel parent) {
		super(iConn, parent);
	...
	public void traverseChildren()
	{
		...
		SFBONComponent.println("Dataflow Connection");	
