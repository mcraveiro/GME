...
// Setup program for the GME Component Wizard for VC++ 8.0 (Visual Studio 2005)
...
function main()
{
	...
	try
	{
		var strVC9Key = "HKLM\\Software\\Microsoft\\VisualStudio\\8.0\\Setup\\VC\\ProductDir";
	...
	catch(e)
	{
		try
		{
			var strVC9Key_x64 = "HKLM\\Software\\Wow6432Node\\Microsoft\\VisualStudio\\8.0\\Setup\\VC\\ProductDir";
			strValue = WSShell.RegRead(strVC9Key_x64);
		}
		catch(e)
		{
			WScript.Echo("ERROR: Cannot find where Visual Studio 2005 is installed.");
			return;
		}
	}
