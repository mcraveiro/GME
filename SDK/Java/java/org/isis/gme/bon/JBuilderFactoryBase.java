...
{	
	static Hashtable customModels;
	static Hashtable customModelRefs;
	static Hashtable customAtoms;
	static Hashtable customAtomRefs;
	static Hashtable customConns;
	static Hashtable customSets;

	public static void Initialize()
	{	
            
            
                customModels = new Hashtable();
		customModelRefs = new Hashtable();
		customAtoms = new Hashtable();
		customAtomRefs = new Hashtable();
		customConns = new Hashtable();
		customSets = new Hashtable();
