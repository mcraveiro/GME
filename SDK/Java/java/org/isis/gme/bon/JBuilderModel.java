...
public class JBuilderModel extends JBuilderObject
{
	...
	protected Vector connchildren;
	protected Vector models;
	protected Hashtable referenceLists;
	protected Hashtable modelLists;
	protected Hashtable atomLists;
	protected Hashtable modelReferenceLists;
	protected Hashtable connectionLists;
	protected Vector sets;
	protected Hashtable setLists;
	...
	{	super(iModel,parent);
		...
		children = new Vector();
		connchildren = new Vector();
		models = new Vector();
			
		modelLists = new Hashtable();
		atomLists = new Hashtable();
		referenceLists = new Hashtable();
		modelReferenceLists = new Hashtable();
		connectionLists = new Hashtable();
		
		sets = new Vector();
		setLists = new Hashtable();
	...
	{	Vector objectlist;
		...
		{	MgaMetaRole role = roles.getItem(i);
			...
			{	String part = role.getName();
				objectlist = (Vector)modelLists.get(part);
		...
		{	MgaFCO chd = chds.getItem(i);
            ...
            objectlist = (Vector)modelLists.get(o.getPartName());
	...
	{	Vector objectlist;
		...
		{	MgaMetaRole role = roles.getItem(i);
			...
			{	String part = role.getName();
				objectlist = (Vector)referenceLists.get(part);
	...
	{	Vector objectlist;
		...
		{	MgaMetaRole role = roles.getItem(i);
			...
			{	String part = role.getName();
				objectlist = (Vector)atomLists.get(part);
		...
		{	MgaFCO chd = chds.getItem(i);
			...
			objectlist =(Vector) atomLists.get(o.getPartName());
			//Support.Assert(objectlist!=null,"Part Name not found");
	...
	{	Vector objectlist;
		...
		{	MgaFCO chd = chds.getItem(i);
			...
			JBuilderConnection o = addConnection(new MgaSimpleConnection(chd));
		}
	}
...
//	}
	...
	public void getAspectNames(Vector list)
	{	//Support.Assert(list!=null,"List provided is null");
		MgaMetaAspects asps = metaModel.getAspects();
		//Support.Assert(asps!=null,"No aspects found in the meta");
	...
	{	Vector objectlist = (Vector)modelLists.get(partName);
	...
	{	Vector objectlist = (Vector)atomLists.get(partName);
		MgaMetaRole role = metaModel.getRoleByName(partName);
